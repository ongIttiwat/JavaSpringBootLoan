...
public class LoanControllerTest {
    ...
    @DisplayName("Test get loan Info by id equals 1 should return loan inforamation")
    @Test
    public void testGetLoanInfoByIdEquals1() throws Exception {
        Long reqParam = 1L;
    ...
    @DisplayName("Test get loan info by id equal 2 should throw loan Exception loan info not found")
    @Test
    public void testGetLoanInfoByIdEquals2() throws Exception {
        Long reqParam = 2L;
        when(loanService.getLoanInfoById(reqParam)).thenThrow(
                new LoanException(LoanError.GET_LOAN_INFO_NOT_FOUND, HttpStatus.NOT_FOUND)
        );
    ...
    @DisplayName("Test get loan info by id equal 2 should throw Exception")
    @Test
    void testGetLoanInfoByIdEquals3() throws Exception {
        ...
        assertEquals("Can't get loan information",status.get("message").toString());
    }
